...
![Alt text](src/assets/screenshots/HomeScreen.png "HomeScreen Mobile"){:height="50%"}

![Alt text](src/assets/screenshots/MovieInfoScreenMobile.png "MovieInfoScreen Mobile"){:height="50%"}

![Alt text](src/assets/screenshots/SearchResultsScreen.png "SearchResultsScreen Mobile"){:height="50%"}
